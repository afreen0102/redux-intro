...
function accountReducer(state = initialStateAccount, action){
   switch(action.type){
    ...
    case 'account/requestLoan':
        ...
        return {
            ...state, loan: action.payload.amount, loanPurpose: action.payload.purpose, balance: action.payload.amount + state.balance
        } 
...
store.dispatch(getLoan(700, "to buy a car"));
...
store.dispatch(createCustomer("Afreen Syed", "18f71a0503"));
store.dispatch(updateName("Saif Ali"));
